...
🔗 **[mcpserver.design](https://mcpserver.design)** — Sign up free, test your connection, subscribe when ready.
...
| Tool | Description |
|---|---|
| `list_tables` | Returns all tables and schemas in your database |
| `describe_table` | Returns columns, types, and constraints for a table |
| `query_table` | Runs a filtered SELECT query on a specific table |
| `execute_sql` | Runs a custom SELECT query |
...
|---|---|---|
| Free | $0 | Test mode |
| Starter | $19/month | 2 databases |
| Lifetime | $69 one-time | 2 databases + lifetime updates |

[Start free at mcpserver.design](https://mcpserver.design) — no credit card required to test your connection.
...
- 🌐 Marketing site & blog: [mcpserver.design](https://mcpserver.design)
- 📖 Setup guides: [mcpserver.design/blog](https://mcpserver.design/blog)
...
Built by [Sam H](https://www.linkedin.com/in/mghtut/) — founder of Synra and [AppSkale](https://appskale.ai).
