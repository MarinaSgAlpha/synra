    ...
    <html lang="en" className="dark">
      <head>
        ...
        <Script
          ...
          strategy="afterInteractive"
        />
        {/* Mixpanel is initialized via the mixpanel-browser SDK
            inside MixpanelProvider (mounted in the dashboard layout)
            so we can identify users and emit named events. */}
